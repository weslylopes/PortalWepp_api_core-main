...
namespace SylerBackend.Infra.Migrations
{
    ...
    [Migration("20190713033824_add_multi_level")]
    partial class add_multi_level
    {
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.MultiLevel", b =>
                {
                    ...
                    b.Property<string>("_fk_id")
                        .HasColumnName("FK_ID");

                    b.Property<int?>("_id_pai")
                        .HasColumnName("ID_PAI");

                    b.Property<int?>("_nivel")
                        .HasColumnName("NIVEL");

                    b.Property<Guid>("_type_level_id")
                        .HasColumnName("TYPE_LEVEL_ID");
