...
namespace SylerBackend.Infra.Migrations
{
    ...
    [Migration("20190707161149_add_type_level")]
    partial class add_type_level
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.Contato", b =>
                {
                    ...
                    b.Property<Guid>("_user_id_create")
                        .HasColumnName("USER_ID_CREATE");

                    b.Property<string>("_whatsapp")
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.MultiLevel", b =>
                {
                    b.Property<Guid>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID");
                    ...
                    b.Property<Guid>("_id_pai")
                        .HasColumnName("ID_PAI");

                    b.Property<Guid>("_level_type_id")
                        .HasColumnName("LEVEL_TYPE_ID");

                    b.Property<int?>("_nivel")
                        .HasColumnName("NIVEL");
                    ...
                    b.HasIndex("_level_type_id");

                    b.HasIndex("_person_id");

                    b.HasIndex("_user_id");

                    b.ToTable("MULTI_LEVEL");
                });
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.PerfilItem", b =>
                {
                    ...
                    b.Property<Guid>("_menu_cliente_id")
                        .HasColumnName("MENU_CLIENTE_ID");
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.System.Bairro", b =>
                {
                    b.Property<int>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.HasIndex("_municipio_id");

                    b.ToTable("BAIRRO");
                });

            modelBuilder.Entity("SylerBackend.Domain.Entities.System.Estado", b =>
                {
                    b.Property<int>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.HasIndex("_regiao_id");

                    b.ToTable("ESTADO");
                });

            modelBuilder.Entity("SylerBackend.Domain.Entities.System.Municipio", b =>
                {
                    b.Property<int>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.HasIndex("_estado_id");

                    b.ToTable("MUNICIPIO");
                });

            modelBuilder.Entity("SylerBackend.Domain.Entities.System.Regiao", b =>
                {
                    b.Property<int>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.TypeLevel", b =>
                {
                    b.Property<Guid>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.MultiLevel", b =>
                {
                    b.HasOne("SylerBackend.Domain.Entities.Person", "_person")
                        .WithMany()
                        .HasForeignKey("_person_id")
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.PerfilItem", b =>
                {
                    b.HasOne("SylerBackend.Domain.Entities.MenuCliente", "_menu_cliente")
                        .WithMany()
                        .HasForeignKey("_menu_cliente_id")
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.System.Bairro", b =>
                {
                    b.HasOne("SylerBackend.Domain.Entities.System.Municipio", "_municipio")
                        .WithMany()
                        .HasForeignKey("_municipio_id")
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.System.Estado", b =>
                {
                    b.HasOne("SylerBackend.Domain.Entities.System.Regiao", "_regiao")
                        .WithMany()
                        .HasForeignKey("_regiao_id")
            ...
            modelBuilder.Entity("SylerBackend.Domain.Entities.System.Municipio", b =>
                {
                    b.HasOne("SylerBackend.Domain.Entities.System.Estado", "_estado")
                        .WithMany()
                        .HasForeignKey("_estado_id")
